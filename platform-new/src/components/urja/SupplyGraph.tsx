...
import type { GraphEdge, GraphNode } from "@/lib/supply";

const HOT = "rgba(248, 113, 113, 1)";
...
export function SupplyGraph({
  ...
  const isHotNode = (n: any) => n.hot || (n.baseline_risk != null && n.baseline_risk !== n.risk);
  const hotIds = new Set(nodes.filter(isHotNode).map(n => n.id));
